...
namespace input::reader {
	using FieldMapping [[deprecated("Remove in v4.1. Use zeek::input::reader::FieldMapping.")]] = zeek::input::reader::FieldMapping;
	using Ascii [[deprecated("Remove in v4.1. Use zeek::input::reader::Ascii.")]] = zeek::input::reader::Ascii;
} // namespace input::reader
